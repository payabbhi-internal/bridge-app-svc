...
bridge-app-svc: main.go
	go build -ldflags "-X github.com/paypermint/mskit.Commit=${commit} -X github.com/paypermint/mskit.Branch=${branch} -X github.com/paypermint/mskit.MskitCommit=${mskit_commit}"
...
local: clean bridge-app-svc

# release: clean bridge-app-svc.ubuntu
#
